...
int main() {
    ...
    for (int i = 0; i < ITERATIONS; i++) {
        ...
        asm volatile(
            ...
            //jump to push+jmp instruction
            "jmp obviously\n"


            "A:\n"
            /*now rdi points to second timestamp as
            jmp instruction is 2 bits wide*/
            "add $2, %%rdi\n\t"
            ...
            "obviously:\n"
            //get memory address of jmp A instruction 
            "lea (%%rip), %%rdi\n"
            //jump
            "jmp A\n"
       
            //second timestamp (where ret returns)
            "RDTSC\n\t"
            "movq %%rdx, %2\n\t"
            "movq %%rax, %3\n\t"
